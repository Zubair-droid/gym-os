...
export default function FoodScanner({ onScanComplete, onClose }) {
    ...
    const analyzeFood = async () => {
        ...
        try {
            ...
            const prompt = `
        You are a nutrition expert specializing in South Indian cuisine. 
        Analyze this food image. 
        
        CRITICAL RULES:
        1. Identify the food specifically in the context of Tamil Nadu/South Indian cuisine (e.g., distinguish between 'Idli', 'Kal Dosai', 'Pongal', 'Vada', 'Sambar').
        2. If it is a common Indian dish, provide the name in "English (Tamil Script)". Example: "Masala Dosa (மசால் தோசை)".
        3. Estimate calories and macros based on standard Indian serving sizes (e.g., 1 Idli is approx 30-40g).
        4. Provide a 1-line health tip in "Tanglish" (Tamil + English mix) that a gym trainer would say.

        Return ONLY a JSON object with this structure (no markdown, just raw JSON):
        {
          "food_name": "String (e.g., 'Chicken Biryani (சிக்கன் பிரியாணி)')",
          "calories": Integer (approx total calories),
          "protein": Integer (grams),
          "carbs": Integer (grams),
          "fats": Integer (grams),
          "analysis": "String (Short Tanglish advice. Example: 'Good carbs, boss! But chutney control pannunga.')"
        }
