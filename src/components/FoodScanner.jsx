      ...
      {!image ? (
        ...
        <>
          ...
          <div className="d-flex gap-2">
            <button onClick={() => setImage(null)} className="btn btn-outline-light flex-grow-1" disabled={scanning}>RETAKE</button>
            <button onClick={analyzeFood} className="btn btn-neon flex-grow-1" disabled={scanning}>
